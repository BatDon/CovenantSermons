 ...
 *
 * The drawables used by ModifiedPlayerNotificationManager can be overridden by drawables with the same
 ...
 * large icon is obtained from the {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter} injected when creating the
 * ModifiedPlayerNotificationManager.
 */
public class ModifiedPlayerNotificationManager {
    ...
    public interface MediaDescriptionAdapter {
         ...
         * returned. The actual bitmap should be passed to the {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.BitmapCallback} once it has been
         ...
         *
         * @param player The {@link Player} for which a notification is being built.
         * @param callback A {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.BitmapCallback} to provide a {@link Bitmap} asynchronously.
         */
        @Nullable
        Bitmap getCurrentLargeIcon(Player player, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.BitmapCallback callback);
    }
    ...
    public interface CustomActionReceiver {
         ...
         *
         * <p>If multiple {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager} instances are in use at the same time, the
         * {@code instanceId} must be set as an intent extra with key {@link
         * com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager#EXTRA_INSTANCE_ID} to avoid sending the action to every custom
         ...
         * @param instanceId The instance id of the {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager}.
    ...
    public interface NotificationListener {
        ...
        default void onNotificationPosted(
            ...
            Timber.i("onNotificationPosted called");
        }
    }
     ...
     * and calls {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener#onNotificationCancelled(int, boolean)}.
     */
    ...
    private final com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter;
    @Nullable private final com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver customActionReceiver;
    private final Handler mainHandler;
    private final NotificationManagerCompat notificationManager;
    private final IntentFilter intentFilter;
    private final Player.EventListener playerListener;
    private final com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationBroadcastReceiver notificationBroadcastReceiver;
    ...
    @Nullable private com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener notificationListener;
    ...
    @com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.Priority
    private int priority;
    private boolean useChronometer;

    /**
     * @deprecated Use {@link #createWithNotificationChannel(Context, String, int, int, int,
     *     com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter)}.
     */
    @Deprecated
    public static com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager createWithNotificationChannel(
            Context context,
            String channelId,
            @StringRes int channelName,
            int notificationId,
            com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter) {
        Timber.i("1 createWithNotificationChannel");
     ...
     * {@link #createWithNotificationChannel(Context, String, int, int, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter,
     * com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener)} should be used to which a {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener} can be passed.
     ...
     * @param mediaDescriptionAdapter The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter}.
     */
    public static com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager createWithNotificationChannel(
            Context context,
            String channelId,
            ...
            int notificationId,
            com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter) {
        Timber.i("2 createWithNotificationChannel");
        NotificationUtil.createNotificationChannel(
                context, channelId, channelName, channelDescription, NotificationUtil.IMPORTANCE_LOW);
        return new com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager(
                context, channelId, notificationId, mediaDescriptionAdapter);
    }

    /**
     * @deprecated Use {@link #createWithNotificationChannel(Context, String, int, int, int,
     *     com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener)}.
     */
    @Deprecated
    public static com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager createWithNotificationChannel(
            Context context,
            ...
            int notificationId,
            com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter,
            @Nullable com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener notificationListener) {
        Timber.i("3 createWithNotificationChannel");
        return createWithNotificationChannel(
                context,
                channelId,
                channelName,
    ...
    /**
     * Creates a notification manager and a low-priority notification channel with the specified
     * {@code channelId} and {@code channelName}. The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener} passed as the last
     ...
     * @param notificationId The id of the notification.
     * @param mediaDescriptionAdapter The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter}.
     * @param notificationListener The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener}.
     */
    public static com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager createWithNotificationChannel(
            Context context,
            String channelId,
            ...
            com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter,
            @Nullable com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener notificationListener) {
        Timber.i("4 createWithNotificationChannel");
        NotificationUtil.createNotificationChannel(
                context, channelId, channelName, channelDescription, NotificationUtil.IMPORTANCE_LOW);
        return new com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager(
     ...
     *
     * <p>When used within a service, consider using {@link #ModifiedPlayerNotificationManager(Context,
     * String, int, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener)} to which a {@link
     * com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener} can be passed.
     *
     * @param context The {@link Context}.
     * @param channelId The id of the notification channel.
     * @param notificationId The id of the notification.
     * @param mediaDescriptionAdapter The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter}.
     */
    public ModifiedPlayerNotificationManager(
            Context context,
            String channelId,
            int notificationId,
            com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter) {
     ...
     * com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener}. The caller is responsible for creating the notification channel.
     *
     * @param context The {@link Context}.
     * @param channelId The id of the notification channel.
     * @param notificationId The id of the notification.
    ...
    public ModifiedPlayerNotificationManager(
            ...
            @Nullable ModifiedPlayerNotificationManager.NotificationListener notificationListener) {
        this(
                context,
                channelId,
                notificationId,
    ...
    /**
     * Creates a notification manager using the specified notification {@code channelId} and {@link
     * com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver}. The caller is responsible for creating the notification channel.
     *
     * <p>When used within a service, consider using {@link #ModifiedPlayerNotificationManager(Context,
     * String, int, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener, com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver)} to which a
     * {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener} can be passed.
     *
     * @param context The {@link Context}.
     * @param channelId The id of the notification channel.
     * @param notificationId The id of the notification.
     * @param mediaDescriptionAdapter The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter}.
     * @param customActionReceiver The {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver}.
     */
    public ModifiedPlayerNotificationManager(
            Context context,
            String channelId,
            int notificationId,
            com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.MediaDescriptionAdapter mediaDescriptionAdapter,
            @Nullable com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver customActionReceiver) {
        this(
                context,
                channelId,
                notificationId,
     ...
     * com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener} and {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver}. The caller is responsible for creating
    ...
    public ModifiedPlayerNotificationManager(
            ...
            @Nullable com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener notificationListener,
            @Nullable com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver customActionReceiver) {
        Timber.i("ModifiedPlayerNotificationManager constructor called");
        ...
        mainHandler =
                Util.createHandler(
                        Looper.getMainLooper(), msg -> com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.this.handleMessage(msg));
        notificationManager = NotificationManagerCompat.from(context);
        playerListener = new PlayerListener();
        notificationBroadcastReceiver = new com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationBroadcastReceiver();
    ...
    /**
     * Sets the {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener}.
     *
     * <p>Please note that you should call this method before you call {@link #setPlayer(Player)} or
     * you may not get the {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener#onNotificationStarted(int, Notification)}
     ...
     */
    @Deprecated
    public final void setNotificationListener(com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener notificationListener) {
        this.notificationListener = notificationListener;
    }
     ...
     */
    public final void setPriority(@com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.Priority int priority) {
     ...
     */
    public final void setVisibility(@com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.Visibility int visibility) {
    ...
    private void startOrUpdateNotification(Player player, @Nullable Bitmap bitmap) {
        Timber.i("startOrUpdateNotification called");
        ...
        //TODO see if change here if there is a change then notify otherwise don't
        ...
        @Nullable com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.NotificationListener listener = notificationListener;
        if (listener != null) {
    ...
    private void stopNotification(boolean dismissedByUser) {
        Timber.i("stopNotification called");
        if (isNotificationStarted) {
    ...
    protected NotificationCompat.Builder createNotification(
        ...
        Timber.i("createNotification called");
        ...
        if (largeIcon == null) {
            largeIcon =
                    mediaDescriptionAdapter.getCurrentLargeIcon(
                            player, new com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.BitmapCallback(++currentNotificationTag));
        }
     ...
     * map returned by {@link com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.CustomActionReceiver#createCustomActions(Context, int)}. Otherwise the
    ...
    private void postStartOrUpdateNotification() {
        Timber.i("postStartOrUpdateNotification called");
    ...
    private void postUpdateNotificationBitmap(Bitmap bitmap, int notificationTag) {
        Timber.i("postUpdateNotificationBitmap called");
        mainHandler
                .obtainMessage(
    ...
    private class PlayerListener implements Player.EventListener {
        int playBackState=-100;
        boolean executeonPlayerStateChangedMethod=true;
        boolean executeonPlayeronPlayingIsChanged=true;

        //TODO onPlayerStateChanged called twice this causes the error
        @Override
        public synchronized void onPlayerStateChanged(boolean playWhenReady, @Player.State int playbackState) {
            Timber.i("onPlayerStateChanged called");
            Timber.i("playWhenReady= %s", playWhenReady);
            Timber.i("playbackState= %s", playbackState);
            Timber.i("playBackState= %s", playbackState);
            if(executeonPlayerStateChangedMethod){
                Timber.i("executeonPlayerStateChangedMethod= %s",executeonPlayerStateChangedMethod);
                postStartOrUpdateNotification();
                executeonPlayerStateChangedMethod=false;
            }
//            if(playBackState==-100){
//                Timber.i("playBackState=-100");
//                playBackState=playbackState;
//                postStartOrUpdateNotification();
//            }else if(playBackState==playbackState){
//                Timber.i("playBackState==playbackState");
//                return;
//            }else{
//                Timber.i("else postStartOrUpdateNotification");
//                postStartOrUpdateNotification();
//            }
        ...
        public void onIsPlayingChanged(boolean isPlaying) {
            Timber.i("onIsPlayingChanged called");
            if(executeonPlayeronPlayingIsChanged){
                Timber.i("executeonPlayeronPlayingIsChanged= %s",executeonPlayeronPlayingIsChanged);
                postStartOrUpdateNotification();
                executeonPlayeronPlayingIsChanged=false;
            }
        }

        @Override
        public void onTimelineChanged(Timeline timeline, int reason) {
            Timber.i("onTimelineChanged called");
            postStartOrUpdateNotification();
        }

        @Override
        public void onPlaybackParametersChanged(PlaybackParameters playbackParameters) {
            Timber.i("onPlaybackParametersChanged called");
            postStartOrUpdateNotification();
        }

        @Override
        public void onPositionDiscontinuity(int reason) {
            Timber.i("onPositionDiscontinuity called");
            postStartOrUpdateNotification();
        }

        @Override
        public void onRepeatModeChanged(@Player.RepeatMode int repeatMode) {
            Timber.i("onRepeatModeChanged called");
            postStartOrUpdateNotification();
        }

        @Override
        public void onShuffleModeEnabledChanged(boolean shuffleModeEnabled) {
            Timber.i("onShuffleModeEnabledChanged called");
            postStartOrUpdateNotification();
        }
    }
    ...
    private class NotificationBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Player player = com.batdon.covenantsermons.player.ModifiedPlayerNotificationManager.this.player;
            if (player == null
